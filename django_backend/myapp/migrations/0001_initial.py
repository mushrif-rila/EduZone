# Generated by Django 5.0.6 on 2024-07-12 15:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_img', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.profileimg')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subheadings', to='myapp.course')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('subheading', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='myapp.subheading')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('subheading', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='myapp.subheading')),
            ],
        ),
    ]
